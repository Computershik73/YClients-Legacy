 ...
 * сотрудника смена с восьми, у другого с двух, у третьего выходной —
 * общая серая полоса сверху и снизу не говорит ни о ком из них ничего.
 *
 * Пусто — сетка рисуется как раньше, по общим часам работы филиала.
 */
 ...
 *
 * Задаются не напрямую: сетка выводит их из рабочего дня филиала и из самих
