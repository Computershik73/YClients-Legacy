...
/*
 * Календаря на месяц в шторке нет нарочно: он открывается нажатием
 * по дате в панели журнала — там, где о дате и думают. Два входа
 * в один экран удлиняли список, ничего к нему не прибавляя.
 *
 * «Ещё» убран по просьбе заказчика. Вместе с ним из приложения пропали
 * единственные входы в профиль, состав филиала и список услуг —
 * YCMoreController остался в исходниках, но попасть в него больше
 * неоткуда. Настройки прокси в отладочной сборке не потерялись:
 * они есть и в «О программе».
 */
